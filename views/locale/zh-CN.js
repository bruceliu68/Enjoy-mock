export default {
  ...
  p: {
    ...
    docs: {
      header: {
        title: '文档 | 更新日志',
        description: '阅读文档能使你完全掌握 Enjoy Mock 的使用。 | 更新永无止境，只为让你开心。'
      }
    },
    group: {
      header: {
    ...
    login: {
      ...
      about: 'Enjoy Mock 是什么？| 是一个可视化，并且能快速生成模拟数据的服务。',
      feature: [
        'Swagger | 这是一个重磅级特性，通过 Swagger 只需1秒就能创建好项目所有的 Mock 接口，效率瞬间提高了 99%。',
        'Mock.js | 也许你用过这个工具，很棒！现在 Enjoy Mock 内置了 Mock.js，我们可以更愉快的伪造数据了。',
        '文档 | 为了让你掌握 Enjoy Mock，我们提供了非常详尽的使用文档。如果你发现问题或是建议可以与我们进行反馈。',
        '响应式数据 | 想要数据联动那是不可能了，不过 Enjoy Mock 支持响应式数据。通过判断入参返回对应的数据。',
    ...
    new: {
      ...
      form: {
        ...
        swagger: 'Swagger Docs API | 可选 | 如果后台有提供 Swagger 文档（并且没有验证授权的问题）, 于是我们可以在此处填写 Swagger 的接口地址, Enjoy Mock 会自动基于此接口创建 Mock 接口.',
