  ...
  p: {
    ...
    docs: {
      header: {
        ...
        description: 'Read docs and use Enjoy Mock like pro. | Never stop updating.'
      }
    },
    group: {
      header: {
    ...
    login: {
      ...
      about: 'What is Enjoy Mock? | A vitrual API mock up tool, and generate mock up data.',
      feature: [
        'Swagger | Kickass feature, using Swagger to create Mock API in few seconds, increase efficiency up to 99%.',
        'Mock.js | Maybe you used this tool, greate! Now Enjoy Mock integrated Mock.js, it mockes up data more fast.',
        'Docs | We provide comprehensive documents to help you master Enjoy Mock. Contact us, if you found bugs or have feedback.',
        'Responsive Data | Enjoy Mock suport responsive data. It reponses data based on request query parameters.',
    ...
    new: {
      ...
      form: {
        ...
        swagger: 'Swagger Docs API | Optional | If backend provides Swagger Doc (without authentication error), Enjoy Mock will create Mock based on Swagger API address you provide.',
