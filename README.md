...
- [Online Manual](https://easy-mock.com/docs)
  tool to generate an **api.js** file quickly based on **Enjoy Mock**.

## Introduction

> If you're unable to deploy an **Enjoy Mock** service by yourself, the
...
Enjoy Mock is now maintained by
...
## Who Deployed Enjoy Mock

If you deployed Enjoy Mock in your own server, please [tell us](https://github.com/easy-mock/easy-mock/issues/47)
